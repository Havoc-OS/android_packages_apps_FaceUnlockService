...
public class FaceUnlockUtils {
    ...
    public static Intent getServiceIntent() {
        Intent intent = new Intent("com.android.faceunlock.BIND");
        intent.setComponent(ComponentName.unflattenFromString(
                "com.android.faceunlock/com.android.faceunlock.service.FaceAuthService"));
        return intent;
    }

    public static String getServicePackageName() {
        return "com.android.faceunlock";
    }
}
